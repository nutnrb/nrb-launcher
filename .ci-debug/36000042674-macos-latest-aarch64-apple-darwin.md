...
Run: `36000042674`  SHA: `803f7a3883e312a3e8a569ec31033ef20645dd53`  Platform: `macos-latest`  Target: `aarch64-apple-darwin`

### environment
```
Darwin iad20-gt1025-e801e681-824d-468c-a96a-65f63b44d8c9-329B49D493EE.local 25.6.0 Darwin Kernel Version 25.6.0: Fri Jul 31 19:16:43 PDT 2026; root:xnu-12377.161.14~5/RELEASE_ARM64_VMAPPLE arm64
...
```
total 16
drwxr-xr-x   6 runner  staff   192 Sep 24 12:36 .
drwxr-xr-x  10 runner  staff   320 Sep 24 12:36 ..
-rw-r--r--   1 runner  staff  3578 Sep 24 12:38 .rustc_info.json
...
> tauri build --no-bundle --verbose
     ...
     Running [tauri_cli::helpers] beforeBuildCommand `pnpm build`
       Debug [tauri_cli::helpers] Setting environment for hook {"TAURI_ENV_TARGET_TRIPLE": "aarch64-apple-darwin", "TAURI_ENV_PLATFORM": "darwin", "TAURI_ENV_ARCH": "aarch64", "TAURI_ENV_PLATFORM_VERSION": "26.6.2", "TAURI_ENV_FAMILY": "unix"}
...
> nrb-launcher@0.1.0 tauri /Users/runner/work/nrb-launcher/nrb-launcher
> tauri build --target aarch64-apple-darwin --bundles app\,dmg --verbose

       Debug [tauri_cli::helpers::app_paths] Found Tauri project inside /Users/runner/work/nrb-launcher/nrb-launcher/src-tauri on early lookup
        Info [tauri_cli::build] Looking up installed tauri packages to check mismatched versions...
     Running [tauri_cli::helpers] beforeBuildCommand `pnpm build`
       Debug [tauri_cli::helpers] Setting environment for hook {"TAURI_ENV_PLATFORM": "darwin", "TAURI_ENV_PLATFORM_VERSION": "26.6.2", "TAURI_ENV_FAMILY": "unix", "TAURI_ENV_ARCH": "aarch64", "TAURI_ENV_TARGET_TRIPLE": "aarch64-apple-darwin"}
     Running [tauri_cli] Command `sh -c pnpm build`
...
[32m✓ built in 494ms[39m
     Running [tauri_cli] Command `cargo build --bins --features tauri/custom-protocol --release --target aarch64-apple-darwin`
[1m[92m   Compiling[0m nrb-launcher v0.1.0 (/Users/runner/work/nrb-launcher/nrb-launcher/src-tauri)
[1m[92m    Finished[0m `release` profile [optimized] target(s) in 1m 13s
       Built [tauri_cli::build] application at: /Users/runner/work/nrb-launcher/nrb-launcher/src-tauri/target/aarch64-apple-darwin/release/nrb-launcher
    Bundling [tauri_bundler::bundle::macos::app] NRB Launcher.app (/Users/runner/work/nrb-launcher/nrb-launcher/src-tauri/target/aarch64-apple-darwin/release/bundle/macos/NRB Launcher.app)
